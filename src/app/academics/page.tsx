...
export default function AcademicsPage() {
  const programs = [
    ...
    },
    {
      ...
      desc: "From Nursery and ECD up to Grade 10 (SEE), providing a strong foundational education.",
            ...
            {programs.map((prog, i) => (
              <div key={i} className="card" style={{ padding: "2.5rem" }}>
                <div style={{ display: "flex", gap: "1.5rem", alignItems: "flex-start" }}>
                  ...
                  <div>
                    <h2 style={{ fontSize: "1.375rem", fontWeight: 650, marginBottom: "0.5rem", letterSpacing: "-0.01em" }}>
                      {prog.title}
                    </h2>
